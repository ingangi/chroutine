...
HealthReq::HealthReq()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_base_2eproto::scc_info_HealthReq.base);
  SharedCtor();
...
const HealthReq& HealthReq::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_base_2eproto::scc_info_HealthReq.base);
...
HealthRsp::HealthRsp()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_base_2eproto::scc_info_HealthRsp.base);
  SharedCtor();
...
const HealthRsp& HealthRsp::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_base_2eproto::scc_info_HealthRsp.base);
  return *internal_default_instance();
}
